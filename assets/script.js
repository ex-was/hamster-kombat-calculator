const config = {
	...
	specials: {
		...
		items: {
			...
			binance: { name: 'Binance listing' },
			bybit: { name: 'Bybit listing' },
			okx: { name: 'OKX listing' },
			yt1b: { name: 'YouTube 1B views' },
			phone: { name: 'HamsterPhone 16' },
			ttop: { name: 'Telegram top ever' },
			hotel: { name: 'Hotel construction' },
			//card: { name: 'MoonPay' },
